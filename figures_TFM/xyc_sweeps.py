...
pkl_filename = "xyc_sweep_kbr.pkl"
reps = 5
V0 = 100
...
if __name__ == "__main__":
    ...
    plt.legend(loc='center left',bbox_to_anchor=(1., 0.5), title="$k_{br}$", fontsize=11, title_fontsize=12)
    plt.title("(B)", loc="left",x = -0.05, y=1, pad=10, fontsize=16)
    plt.tight_layout()
    plt.savefig("figures_TFM/gillespie_equilibrium_errors_kbr.png", bbox_inches='tight', dpi=300)
    plt.show()